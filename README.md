...
* [Electron](https://github.com/electron/electron) ⭐ 122,862 | 🐛 737 | 🌐 C++ | 📅 2026-09-04 - a Node.js and Chromium runtime to build cross platform desktop apps
...
* [Neutralino](https://github.com/neutralinojs/neutralinojs) ⭐ 8,631 | 🐛 180 | 🌐 C | 📅 2026-09-04 - a runtime to build desktop apps using the system's own web browser (Windows, macOS, Linux)
* [zero-native](https://github.com/vercel-labs/zero-native) ⭐ 7,625 | 🐛 157 | 🌐 Zig | 📅 2026-09-03 - a runtime for small apps (less than 1MB) that use the system WebView or bundle Chromium via CEF (macOS, Linux)
...
* [Tauri](https://tauri.app/) - a runtime using the system's native [webview](https://github.com/tauri-apps/wry) ⭐ 4,942 | 🐛 183 | 🌐 Rust | 📅 2026-09-03 with Rust backend (Windows, macOS, Linux)
...
* [deno\_webview](https://github.com/eliassjogreen/deno_webview) ⭐ 1,591 | 🐛 43 | 🌐 TypeScript | 📅 2025-02-25 - This project provides [deno](https://github.com/denoland/deno) ⭐ 108,367 | 🐛 1,544 | 🌐 Rust | 📅 2026-09-04 bindings for
  [webview](https://github.com/zserge/webview) ⭐ 14,222 | 🐛 212 | 🌐 C++ | 📅 2026-03-09 using the
  [webview rust bindings](https://github.com/Boscop/web-view) ⭐ 1,952 | 🐛 117 | 🌐 JavaScript | 📅 2024-05-09. Currently supports Linux & Windows.
* [graffiti](https://github.com/cztomsik/graffiti) ⭐ 932 | 🐛 2 | 🌐 Zig | 📅 2023-11-08 - build desktop apps with react-native API, render them on GPU using [Servo  WebRender](https://github.com/servo/webrender) ⭐ 3,371 | 🐛 192 | 🌐 Rust | 📅 2026-08-30 (Linux, macOS, and Windows)
...
* [vuido](https://github.com/mimecorg/vuido) ⭐ 6,051 | 🐛 28 | 🌐 JavaScript | 📅 2023-03-01 - a Vue.js environment to build cross platform native desktop apps
...
* [Yoga](https://github.com/facebook/yoga) ⭐ 18,901 | 🐛 175 | 🌐 C++ | 📅 2026-09-01 - a layout engine which implements Flexbox to build cross-platform (node, browser asm, and standalone) apps
