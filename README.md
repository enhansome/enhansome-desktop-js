...
* [Electron](https://github.com/electron/electron) ⭐ 122,640 | 🐛 811 | 🌐 C++ | 📅 2026-08-22 - a Node.js and Chromium runtime to build cross platform desktop apps
...
* [Neutralino](https://github.com/neutralinojs/neutralinojs) ⭐ 8,612 | 🐛 177 | 🌐 C | 📅 2026-08-22 - a runtime to build desktop apps using the system's own web browser (Windows, macOS, Linux)
* [zero-native](https://github.com/vercel-labs/zero-native) ⭐ 7,543 | 🐛 142 | 🌐 Zig | 📅 2026-08-22 - a runtime for small apps (less than 1MB) that use the system WebView or bundle Chromium via CEF (macOS, Linux)
...
* [Tauri](https://tauri.app/) - a runtime using the system's native [webview](https://github.com/tauri-apps/wry) ⭐ 4,926 | 🐛 178 | 🌐 Rust | 📅 2026-08-22 with Rust backend (Windows, macOS, Linux)
...
* [deno\_webview](https://github.com/eliassjogreen/deno_webview) ⭐ 1,592 | 🐛 43 | 🌐 TypeScript | 📅 2025-02-25 - This project provides [deno](https://github.com/denoland/deno) ⭐ 108,269 | 🐛 1,521 | 🌐 Rust | 📅 2026-08-21 bindings for
  [webview](https://github.com/zserge/webview) ⭐ 14,205 | 🐛 210 | 🌐 C++ | 📅 2026-03-09 using the
...
* [Yoga](https://github.com/facebook/yoga) ⭐ 18,878 | 🐛 165 | 🌐 C++ | 📅 2026-08-17 - a layout engine which implements Flexbox to build cross-platform (node, browser asm, and standalone) apps
