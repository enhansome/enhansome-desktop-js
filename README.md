...
* [Electron](https://github.com/electron/electron) ⭐ 122,566 | 🐛 831 | 🌐 C++ | 📅 2026-08-19 - a Node.js and Chromium runtime to build cross platform desktop apps
...
* [zero-native](https://github.com/vercel-labs/zero-native) ⭐ 7,515 | 🐛 139 | 🌐 Zig | 📅 2026-08-18 - a runtime for small apps (less than 1MB) that use the system WebView or bundle Chromium via CEF (macOS, Linux)
...
* [deno\_webview](https://github.com/eliassjogreen/deno_webview) ⭐ 1,592 | 🐛 43 | 🌐 TypeScript | 📅 2025-02-25 - This project provides [deno](https://github.com/denoland/deno) ⭐ 108,256 | 🐛 1,509 | 🌐 Rust | 📅 2026-08-19 bindings for
