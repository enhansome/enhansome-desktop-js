...
* [Electron](https://github.com/electron/electron) ⭐ 122,886 | 🐛 751 | 🌐 C++ | 📅 2026-09-05 - a Node.js and Chromium runtime to build cross platform desktop apps
...
* [Neutralino](https://github.com/neutralinojs/neutralinojs) ⭐ 8,633 | 🐛 180 | 🌐 C | 📅 2026-09-05 - a runtime to build desktop apps using the system's own web browser (Windows, macOS, Linux)
* [zero-native](https://github.com/vercel-labs/zero-native) ⭐ 7,628 | 🐛 159 | 🌐 Zig | 📅 2026-09-03 - a runtime for small apps (less than 1MB) that use the system WebView or bundle Chromium via CEF (macOS, Linux)
...
* [Tauri](https://tauri.app/) - a runtime using the system's native [webview](https://github.com/tauri-apps/wry) ⭐ 4,944 | 🐛 184 | 🌐 Rust | 📅 2026-09-03 with Rust backend (Windows, macOS, Linux)
...
* [deno\_webview](https://github.com/eliassjogreen/deno_webview) ⭐ 1,591 | 🐛 43 | 🌐 TypeScript | 📅 2025-02-25 - This project provides [deno](https://github.com/denoland/deno) ⭐ 108,371 | 🐛 1,544 | 🌐 Rust | 📅 2026-09-04 bindings for
...
* [Yoga](https://github.com/facebook/yoga) ⭐ 18,901 | 🐛 174 | 🌐 C++ | 📅 2026-09-04 - a layout engine which implements Flexbox to build cross-platform (node, browser asm, and standalone) apps
